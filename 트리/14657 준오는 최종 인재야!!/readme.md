[백준 : 준오는 최종인재야] (https://www.acmicpc.net/problem/14657)



- 트리의 같은 깊이 (지름이 같지만) 거리가 다른 경우가 존재한다!! 이경우를 제대로 확인 못했어서 엄청 틀렸다.
- 그 외에는 전형적인 트리의 지름 문제이다.
...
![20210621_123216](20210621_123216.png)