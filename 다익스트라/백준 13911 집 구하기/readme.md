...
1. 자료구조 -> space에 주거지, 맥도날드,스타벅스,맥도날드이면서 스타벅스인 애들의 상태를 0~3으로 각각 저장
2. 두 번의 다익스트라를 통해 맥세권거리, 스세권거리를 출력
3. 맥세권이면서 스세권인 두 조건을 충족하면서 가장 작은 값 출력
...
![20210226_141554](C:\Users\cws89\Documents\algorithm\다익스트라\백준 13911 집 구하기\readme\20210226_141554.png)
